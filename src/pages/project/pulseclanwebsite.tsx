      ...
      <div className={styles.text_wrapper}>
        ...
        <section id='landingpage'>
          ...
          <p className={`${styles.paragraph} ${styles.paragraph_img_below}`}>
            In order to reduce the time it takes for the the background video to
            start playing once the page loaded, a video streaming endpoint was
            implemented in Express which allows the client to start playing the
            already downloaded chunks, while it downloads the rest of the file
            in the background.{' '}
          </p>
          <h3 className={styles.subheading}>News and social media sections</h3>
          <img
          ...
          <p className={`${styles.paragraph} ${styles.paragraph_img_below}`}>
            All of the numbers here are customizable through the CMS in order to
            be easily updated.
          </p>
          <img
          ...
          <p className={`${styles.paragraph} ${styles.paragraph_img_below}`}>
            ...
            currently active streamers. For the latest videos part, the Youtube
            API is being used to provide that data automatically, but the catch
            is that said API has a daily limit, so we&apos;re caching the API
            responses in our database in order to circumvent that limitation.
            And whenever new videos are uploaded and the page needs to be
            updated, a simple button was added on the CMS dashboard which will
            hit an endpoint on the server to fetch new data from Youtube and
            update the database.
          </p>
          <img
          ...
          <p className={`${styles.paragraph} ${styles.paragraph_below}`}>
            ...
            to be hit on our back-end in order to get the picture links for each
            streamer. I decided to divide these two calls into different
          ...
          <p className={`${styles.paragraph}`}>
            ...
            server is hitting expire after certain time. So another endpoint was
            needed in order to check for 401 (unauthorized) responses from
        ...
        <section id='applications'>
          ...
          <p className={`${styles.paragraph}`}>
            Pulse Clan has multiple roles open for recruiting, and each role has
            specific form fields and different requirements, so conditional
            rendering came in handy.{' '}
          </p>
          <img
          ...
          <p className={`${styles.paragraph} ${styles.paragraph_img_below}`}>
            Once the applicant fills the form and sends it, the server takes the
            request and puts it in the database. Additionally by request of the
            client, each application is sent automatically to Discord channels
            for easier viewing. Discord makes this possible with their webhook
            implementation.{' '}
          </p>
          <img
        ...
        <section id='roster'>
          ...
          <p className={`${styles.paragraph} ${styles.paragraph_img_below}`}>
            ...
            avoid roster sections with too many members from making the page too
            cluttered.
          </p>
          <video
            className={styles.project_img}
          ...
          <p className={`${styles.paragraph} ${styles.paragraph_below}`}>
            ...
            edit members from their respective section, edit the order in which
            the members appear on that section, and alter each members&apos;
            information for them.
          </p>
          <p className={`${styles.paragraph} ${styles.paragraph_below}`}>
            Members from upper management can additionally promote / demote
            members into and out of management positions, and move members from
            one roster section to another.
          </p>
          <video
            className={styles.project_img}
            controls
        ...
        <section id='cms'>
          ...
          <p className={`${styles.paragraph} ${styles.paragraph_below}`}>
            ...
            functionality are dictated by what authorization type the user has.
          </p>
          <p className={`${styles.paragraph} ${styles.paragraph_below}`}>
            On the “View applications” page, division leads can only see
            applications pertinent to their division (i.e the lead designer can
            only see designer applications and so on). Similarly, on the “Manage
            members” page, the division leads can only register new members
            pertinent to their own roster section on the website (i.e the lead
            editor can only add members to the editor roster and so on), and
            they can&apos;t assign or modify their management roles or anyone
            else&apos;s.
          </p>
          <p className={`${styles.paragraph} ${styles.paragraph_below}`}>
        ...
        <section id='deployment'>
          ...
          <p className={`${styles.paragraph} ${styles.paragraph_below}`}>
            ...
            requirements and kept monthly costs in check. The droplet provided a
            Virtual Private Server (VPS) that gave me all the flexibility i
            needed.
          </p>
          <p className={`${styles.paragraph} ${styles.paragraph_below}`}>
